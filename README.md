...
function DarkraiX:Window(text,gamenme,logo,keybind)
	...
	function uitab:AddTab(text)
		...
		TabButton.TextColor3 = Color3.fromRGB(0, 255, 247)
		...
		function main:AddButton(text,callback)
			...
			TextBtn.Text = text
			TextBtn.TextColor3 = Color3.fromRGB(0, 255, 247)
		...
		function main:AddToggle(text,config,callback)
			...
			Label.Text = text
			Label.TextColor3 = Color3.fromRGB(0, 255, 247)
			Label.TextSize = 15.000

			ToggleImage.Name = "ToggleImage"
			ToggleImage.Parent = Toggle
			ToggleImage.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
		...
		function main:AddDropdown(text,option,callback)
			...
			DropTitle.Text = text.. " : "
			DropTitle.TextColor3 = Color3.fromRGB(0, 255, 247)
			...
			for i,v in next,option do
				...
				Item.TextColor3 = Color3.fromRGB(0, 255, 247)
		...
		function main:AddSlider(text,min,max,set,callback)
			...
			SliderLabel.TextColor3 = Color3.fromRGB(0, 255, 247)
			...
			circlebar.BackgroundColor3 = Color3.fromRGB(0, 255, 247)
			...
			TextBox.TextColor3 = Color3.fromRGB(0, 255, 247)
		...
		function main:AddTextbox(text,disappear,callback)
			...
			TextboxLabel.TextColor3 = Color3.fromRGB(0, 255, 247)
			...
			RealTextbox.Text = ""
			RealTextbox.TextColor3 = Color3.fromRGB(0, 255, 247)
